      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="border-b border-slate-200 pb-5">
          ...
          <p className="text-[#64748b] mt-2 max-w-2xl text-sm leading-relaxed">
            Sube el PDF del examen médico ocupacional. La inteligencia artificial analizará el documento y extraerá automáticamente las recomendaciones y restricciones laborales.
          </p>
        </div>

    ...
    <main className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 sm:py-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Sube y administra los documentos obligatorios de esta empresa. Cada carga exitosa
          actualiza el porcentaje de cumplimiento segun el peso configurado para cada tipo de
          documento.
        </p>
      </div>

      <ClientDocumentsUpload companyId={companyId} />
    </main>
  )
}
